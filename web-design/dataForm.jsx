...
const API_URL = 'https://main--serverless-api-recipes.netlify.app/.netlify/functions/api/';
                ...
                <div className="modal">
                    <div className="modal-content">
                        ...
                        <form className="add-form" onSubmit={handleSubmit}>
                            ...
                            <button className="searchButton" type="submit">{editItem ? 'Update Recipe' : 'Add Recipe'}</button>
                        </form>
                    </div>
                </div>
            )}
